...
public class DetailActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (intent != null && intent.hasExtra(/*Intent.EXTRA_TEXT*/DETAIL_MOVIE)) {
            movie = intent.getExtras().getParcelable(DETAIL_MOVIE);
        }
        if(movie != null){
            ImageView imageView = (ImageView)rootView.findViewById(R.id.backdrop_img);

            Picasso.with(getContext()).load(movie.backdropPath).into(imageView);
            final TextView movieTitle = (TextView)rootView.findViewById(R.id.detail_movie_title);
            movieTitle.setText(movie.originatTtile);
            ...
            voteRateTextView.setText(movie.voteAverage + "/10");
            ...
            trailers.setOnItemClickListener(new LinearListView.OnItemClickListener() {
                ...
                public void onItemClick(LinearListView linearListView, View view,
                    ...
                    intent.setData(Uri.parse("http://www.youtube.com/watch?v=" + trailer.key));
            ...
            final Uri movieUri =
                    MoviesContract.MovieEntry.buildMoviesUri(Long.parseLong(movie.id));
            final Cursor cursor =
            ...
            favoriteSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(final CompoundButton buttonView, final boolean isChecked) {
                    if (isChecked) {
                        final long movieId = Long.parseLong(movie.id);
                        final Uri movieUri = MoviesContract.MovieEntry.buildMoviesUri(movieId);
                        Log.v("DB", movieUri.toString());
                        final Cursor cursor =
                                getActivity().getContentResolver().query(movieUri, null, null, null, null);
                        if (cursor != null) {
                            ...
                            if (!cursor.moveToFirst()) {
                                ...
                                movieValues.put(MoviesContract.MovieEntry.COLUMN_ID, movie.id);
                                movieValues.put(MoviesContract.MovieEntry.COLUMN_TITLE, movie.originatTtile);
    ...
    public void onStart() {
        ...
        if(movie != null){
            ...
            new FetchTrailersTask().execute(movie.id);
        }
    }
    ...
    public class FetchTrailersTask extends AsyncTask<String, Void, List<Trailer>> {
        ...
        protected List<Trailer> doInBackground(String... params) {
            ...
            try {
                ...
                Uri builtUri = Uri.parse(BASE_URL).buildUpon()
                        .appendQueryParameter(API_KEY_PARAM, getActivity().getString(R.string.api_key))
                        .build();
